...
mod tests {
    ...
    fn test_cycle_detection() {
        ...
        tracker.entries.insert(TestSetupKey::A, world.register_system(|| Progress::DONE));
        tracker.entries.insert(TestSetupKey::B, world.register_system(|| Progress::DONE));
        tracker.entries.insert(TestSetupKey::C, world.register_system(|| Progress::DONE));
        tracker.entries.insert(TestSetupKey::D, world.register_system(|| Progress::DONE));
        ...
        let provider_d = ProviderInfo::new(
            vec![],
            vec![TestSetupKey::D],
            Cow::Borrowed("provider_d"),
        );

        tracker.providers.insert(world.register_system(|| {}), provider_a);
        tracker.providers.insert(world.register_system(|| {}), provider_b);
        tracker.providers.insert(world.register_system(|| {}), provider_c);
        tracker.providers.insert(world.register_system(|| {}), provider_d);
    ...
    fn test_provider_should_run() {
        ...
        tracker.entries.insert(TestSetupKey::A, world.register_system(|| Progress::DONE));
        tracker.entries.insert(TestSetupKey::B, world.register_system(|| Progress::ZERO));
        tracker.entries.insert(TestSetupKey::C, world.register_system(|| Progress::ZERO));
    ...
    fn test_validation_unprovided_keys() {
        ...
        world.resource_scope::<SetupTracker<TestSetupKey>, _>(|world, mut tracker| {
            ...
            tracker.providers.insert(world.register_system(|| {}), provider);
        });
    ...
    fn test_validation_duplicate_providers() {
        ...
        world.resource_scope::<SetupTracker<TestSetupKey>, _>(|world, mut tracker| {
            ...
            let provider1 = ProviderInfo::new(
                vec![],
                vec![TestSetupKey::A],
                Cow::Borrowed("provider1"),
            );
            let provider2 = ProviderInfo::new(
                vec![],
                vec![TestSetupKey::A],
                Cow::Borrowed("provider2"),
            );

            tracker.providers.insert(world.register_system(|| {}), provider1);
            tracker.providers.insert(world.register_system(|| {}), provider2);
        });
